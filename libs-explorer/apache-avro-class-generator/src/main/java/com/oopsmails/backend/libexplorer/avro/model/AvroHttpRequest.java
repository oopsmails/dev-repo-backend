...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8451206577287545506L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroHttpRequest\",\"namespace\":\"com.oopsmails.backend.libexplorer.avro.model\",\"fields\":[{\"name\":\"requestTime\",\"type\":\"long\"},{\"name\":\"clientIdentifier\",\"type\":{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}},{\"name\":\"employeeNames\",\"type\":{\"type\":\"array\",\"items\":\"string\"},\"default\":[]},{\"name\":\"active\",\"type\":{\"type\":\"enum\",\"name\":\"Active\",\"symbols\":[\"YES\",\"NO\"]}},{\"name\":\"accounts\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"AccountIdentifier\",\"fields\":[{\"name\":\"accountNumber\",\"type\":\"string\"},{\"name\":\"accountType\",\"type\":{\"type\":\"enum\",\"name\":\"AccountType\",\"symbols\":[\"SAVING\",\"CHECKING\"]}}]}},\"default\":[]}]}");
  ...
  public static AvroHttpRequest fromByteBuffer(
   ...
   private com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier clientIdentifier;
   private java.util.List<java.lang.CharSequence> employeeNames;
   private com.oopsmails.backend.libexplorer.avro.model.Active active;
   private java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> accounts;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, com.oopsmails.backend.libexplorer.avro.model.Active active, java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> accounts) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (com.oopsmails.backend.libexplorer.avro.model.Active)value$; break;
    case 4: accounts = (java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier value) {
   ...
   */
  public com.oopsmails.backend.libexplorer.avro.model.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.oopsmails.backend.libexplorer.avro.model.Active value) {
    this.active = value;
  }
   ...
   */
  public java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> getAccounts() {
    return accounts;
  }
   ...
   * @param value the value to set.
   */
  public void setAccounts(java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> value) {
    this.accounts = value;
  }
   ...
   */
  public static com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder newBuilder() {
    return new com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder newBuilder(com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder other) {
    if (other == null) {
      return new com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder();
    } else {
      return new com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder(other);
    }
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder newBuilder(com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest other) {
    if (other == null) {
      return new com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder();
    } else {
      return new com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private long requestTime;
    private com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier clientIdentifier;
    private com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private com.oopsmails.backend.libexplorer.avro.model.Active active;
    private java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> accounts;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
      ...
      if (isValidValue(fields()[4], other.accounts)) {
        this.accounts = data().deepCopy(fields()[4].schema(), other.accounts);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder setClientIdentifier(com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier.newBuilder());
        }
      }
    ...
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder setActive(com.oopsmails.backend.libexplorer.avro.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder setAccounts(java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.backend.libexplorer.avro.model.AvroHttpRequest.Builder clearAccounts() {
      accounts = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.oopsmails.backend.libexplorer.avro.model.Active) defaultValue(fields()[3]);
        record.accounts = fieldSetFlags()[4] ? this.accounts : (java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier>) defaultValue(fields()[4]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    long size1 = this.accounts.size();
    out.writeArrayStart();
    out.setItemCount(size1);
    long actualSize1 = 0;
    for (com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier e1: this.accounts) {
      actualSize1++;
      out.startItem();
      e1.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.clientIdentifier == null) {
        this.clientIdentifier = new com.oopsmails.backend.libexplorer.avro.model.ClientIdentifier();
      }
      ...
      this.active = com.oopsmails.backend.libexplorer.avro.model.Active.values()[in.readEnum()];

      long size1 = in.readArrayStart();
      java.util.List<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> a1 = this.accounts;
      if (a1 == null) {
        a1 = new SpecificData.Array<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier>((int)size1, SCHEMA$.getField("accounts").schema());
        this.accounts = a1;
      } else a1.clear();
      SpecificData.Array<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier>)a1 : null);
      for ( ; 0 < size1; size1 = in.arrayNext()) {
        for ( ; size1 != 0; size1--) {
          com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier e1 = (ga1 != null ? ga1.peek() : null);
          if (e1 == null) {
            e1 = new com.oopsmails.backend.libexplorer.avro.model.AccountIdentifier();
          }
          e1.customDecode(in);
          a1.add(e1);
        }
